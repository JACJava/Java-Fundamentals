...
//        //Machine machine = new Printer(true, "My Printer"); //created machine as a printer, calling turnon method in printer
//        Machine machine = new Machine(false);  //created machine as a machine, calling turnon method in machine
//
//        machine.turnOn();
        ...
        //IMachine machine = new Printer(true, "My Printer"); //created machine as a printer, calling turnon method in printer
        ...
        Printer<BWCartridge> printer2 = new Printer<BWCartridge>(true, "My Printer", new BWCartridge());
        printer2.print(1);

        Printer<ColorCartridge> printer3 = new Printer<ColorCartridge>(true, "My Printer", new ColorCartridge());
        printer3.printUsingCartridge(new ColorCartridge(), "Hi!");

        Printer<BWCartridge> printer4 = new Printer<BWCartridge>(true, "My Printer", new BWCartridge());
        printer4.printUsingCartridge(new BWCartridge(), "Hi again!");

        Printer<BWCartridge> printer5 = new Printer<BWCartridge>(true, "My Printer", new BWCartridge());
        printer5.print(1);
